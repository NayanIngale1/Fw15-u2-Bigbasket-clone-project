...
var snacksBrandedFood = JSON.parse(localStorage.getItem("snaksData"));
var OneProduct = [];
...
document.getElementById(
  "totalItems"
).innerHTML = `(${snacksBrandedFood.length})`;

displayProduct(snacksBrandedFood);
function displayProduct(snacksBrandedFood) {
  document.querySelector("#gridcontainer").innerHTML = "";

  snacksBrandedFood.map(function (element, index) {
...
function fresho() {
  ...
  console.log(value5);
  if (value5 == true) {
    var fresho_item = snacksBrandedFood.filter(function (element, index) {
...
function bbcombo() {
  ...
  if (value6 == true) {
    var fresho_item1 = snacksBrandedFood.filter(function (element, index) {
...
function LessthanRs20() {
  ...
  if (Rs == true) {
    var lessthanRs20 = snacksBrandedFood.filter(function (element) {
...
function BetweenRs21toRs50() {
  ...
  if (Rs == true) {
    var BetweenRs21toRs50 = snacksBrandedFood.filter(function (element) {
...
function BetweenRs51toRs100() {
  ...
  if (Rs == true) {
    var BetweenRs51toRs100 = snacksBrandedFood.filter(function (element) {
...
function BetweenRs101toRs200() {
  ...
  if (Rs == true) {
    var BetweenRs101toRs200 = snacksBrandedFood.filter(function (element) {
...
function BetweenRs201toRs500() {
  ...
  if (Rs == true) {
    var BetweenRs201toRs500 = snacksBrandedFood.filter(function (element) {
...
function Between_15_25() {
  ...
  if (between_15_25 == true) {
    var Between_15_25 = snacksBrandedFood.filter(function (element) {
...
function Morethan25() {
  ...
  if (morethan25 == true) {
    var Morethan25 = snacksBrandedFood.filter(function (element) {
...
function sorting() {
  ...
  console.log(value2);
  if (value2 == "low") {
    snacksBrandedFood.sort(function (a, b) {
      return Number(a.productprice) - Number(b.productprice);
      //category_page(snacksBrandedFood);
    });
    displayProduct(snacksBrandedFood);
  }
  if (value2 == "high") {
