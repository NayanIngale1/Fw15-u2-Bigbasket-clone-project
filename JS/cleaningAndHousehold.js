...
var cleaningHousehold = JSON.parse(localStorage.getItem("cleanHouseData"));
var OneProduct = [];
...
document.getElementById(
  "totalItems"
).innerHTML = `(${cleaningHousehold.length})`;

displayProduct(cleaningHousehold);
function displayProduct(cleaningHousehold) {
  document.querySelector("#gridcontainer").innerHTML = "";

  cleaningHousehold.map(function (element, index) {
...
function fresho() {
  ...
  console.log(value5);
  if (value5 == true) {
    var fresho_item = cleaningHousehold.filter(function (element, index) {
...
function bbcombo() {
  ...
  if (value6 == true) {
    var fresho_item1 = cleaningHousehold.filter(function (element, index) {
...
function LessthanRs20() {
  ...
  if (Rs == true) {
    var lessthanRs20 = cleaningHousehold.filter(function (element) {
...
function BetweenRs21toRs50() {
  ...
  if (Rs == true) {
    var BetweenRs21toRs50 = cleaningHousehold.filter(function (element) {
...
function BetweenRs51toRs100() {
  ...
  if (Rs == true) {
    var BetweenRs51toRs100 = cleaningHousehold.filter(function (element) {
...
function BetweenRs101toRs200() {
  ...
  if (Rs == true) {
    var BetweenRs101toRs200 = cleaningHousehold.filter(function (element) {
...
function BetweenRs201toRs500() {
  ...
  if (Rs == true) {
    var BetweenRs201toRs500 = cleaningHousehold.filter(function (element) {
...
function Between_15_25() {
  ...
  if (between_15_25 == true) {
    var Between_15_25 = cleaningHousehold.filter(function (element) {
...
function Morethan25() {
  ...
  if (morethan25 == true) {
    var Morethan25 = cleaningHousehold.filter(function (element) {
...
function sorting() {
  ...
  console.log(value2);
  if (value2 == "low") {
    cleaningHousehold.sort(function (a, b) {
      return Number(a.productprice) - Number(b.productprice);
      //category_page(cleaningHousehold);
    });
    displayProduct(cleaningHousehold);
  }
  if (value2 == "high") {
