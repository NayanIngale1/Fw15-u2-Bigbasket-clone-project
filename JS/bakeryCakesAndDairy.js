...
var bakeryCakesDairy = JSON.parse(localStorage.getItem("bakeryCakesData"));
var OneProduct = [];
...
document.getElementById(
  "totalItems"
).innerHTML = `(${bakeryCakesDairy.length})`;

displayProduct(bakeryCakesDairy);
function displayProduct(bakeryCakesDairy) {
  document.querySelector("#gridcontainer").innerHTML = "";

  bakeryCakesDairy.map(function (element, index) {
...
function fresho() {
  ...
  console.log(value5);
  if (value5 == true) {
    var fresho_item = bakeryCakesDairy.filter(function (element, index) {
...
function bbcombo() {
  ...
  if (value6 == true) {
    var fresho_item1 = bakeryCakesDairy.filter(function (element, index) {
...
function LessthanRs20() {
  ...
  if (Rs == true) {
    var lessthanRs20 = bakeryCakesDairy.filter(function (element) {
...
function BetweenRs21toRs50() {
  ...
  if (Rs == true) {
    var BetweenRs21toRs50 = bakeryCakesDairy.filter(function (element) {
...
function BetweenRs51toRs100() {
  ...
  if (Rs == true) {
    var BetweenRs51toRs100 = bakeryCakesDairy.filter(function (element) {
...
function BetweenRs101toRs200() {
  ...
  if (Rs == true) {
    var BetweenRs101toRs200 = bakeryCakesDairy.filter(function (element) {
...
function BetweenRs201toRs500() {
  ...
  if (Rs == true) {
    var BetweenRs201toRs500 = bakeryCakesDairy.filter(function (element) {
...
function Between_15_25() {
  ...
  if (between_15_25 == true) {
    var Between_15_25 = bakeryCakesDairy.filter(function (element) {
...
function Morethan25() {
  ...
  if (morethan25 == true) {
    var Morethan25 = bakeryCakesDairy.filter(function (element) {
...
function sorting() {
  ...
  console.log(value2);
  if (value2 == "low") {
    bakeryCakesDairy.sort(function (a, b) {
      return Number(a.productprice) - Number(b.productprice);
      //category_page(bakeryCakesDairy);
    });
    displayProduct(bakeryCakesDairy);
  }
  if (value2 == "high") {
