...
function displayProduct(FruitVegArr) {
  ...
  FruitVegArr.map(function (element, index) {
...
function fresho() {
  ...
  console.log(value5);
  if (value5 == true) {
    var fresho_item = FruitVegArr.filter(function (element, index) {
...
function bbcombo() {
  ...
  if (value6 == true) {
    var fresho_item1 = FruitVegArr.filter(function (element, index) {
...
function LessthanRs20() {
  ...
  if (Rs20 == true) {
    var lessthanRs20 = FruitVegArr.filter(function (element) {
...
function BetweenRs21toRs50() {
  ...
  if (Rs20 == true) {
    var BetweenRs21toRs50 = FruitVegArr.filter(function (element) {
...
function BetweenRs51toRs100() {
  ...
  if (Rs20 == true) {
    var BetweenRs51toRs100 = FruitVegArr.filter(function (element) {
...
function BetweenRs101toRs200() {
  ...
  if (Rs20 == true) {
    var BetweenRs101toRs200 = FruitVegArr.filter(function (element) {
...
function BetweenRs201toRs500() {
  ...
  if (Rs20 == true) {
    var BetweenRs201toRs500 = FruitVegArr.filter(function (element) {
...
function Between_15_25() {
  ...
  if (between_15_25 == true) {
    var Between_15_25 = FruitVegArr.filter(function (element) {
...
function Morethan25() {
  ...
  if (morethan25 == true) {
    var Morethan25 = FruitVegArr.filter(function (element) {
...
function sorting() {
  ...
  console.log(value2);
  if (value2 == "low") {
    FruitVegArr.sort(function (a, b) {
      return Number(a.productprice) - Number(b.productprice);
      //category_page(FruitVegArr);
    });
    displayProduct(FruitVegArr);
  }
  if (value2 == "high") {
